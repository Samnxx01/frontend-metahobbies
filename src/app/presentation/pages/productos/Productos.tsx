...
// Componente de la Card de Producto
...
const allProducts: ComponentProduct[] = [
    ...
    ...Array.from({ length: 16 }, (_, i) => ({
        ...
        category: ['maquillaje', 'cabello', 'uñas', 'cuidado-facial'][Math.floor(Math.random() * 4)] as string,
    })),
];
...
export default function Productos(): React.ReactElement {
    ...
    const categories: string[] = ['Todos', 'Maquillaje', 'Cabello', 'Uñas', 'Cuidado Facial'];
