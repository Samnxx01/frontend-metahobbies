...
export function ReglasActualizarSaAlcancePanel({
  ...
  return (
    <div className="mb-3 space-y-2 rounded-lg border border-indigo-200/80 bg-indigo-50/40 px-3 py-2.5">
      <p className="text-[11px] font-semibold uppercase tracking-wide text-indigo-950">
        Actualizar regla · alcance SuperAdmin (JWT)
      </p>
      <p className="text-[11px] leading-snug text-indigo-950/80">
      ...
      {tgSel && tgCadena.length > 0 ? (
        <div className="rounded-md border border-sky-200/80 bg-sky-50/80 px-2.5 py-2">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-sky-950">
            Rama tenant global (padre → seleccionado)
          </p>
          <div className="mt-1 flex flex-wrap items-center gap-1 text-[11px] text-sky-950">
