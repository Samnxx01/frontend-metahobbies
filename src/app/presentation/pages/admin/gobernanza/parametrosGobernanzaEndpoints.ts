...
export const ENDPOINTS: EndpointSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'rolGlobal', label: 'Rol global', type: 'id', required: true },
    ],
  },
  {
  ...
  {
    id: 'tenant-superadmin-desactivar',
    section: 'tenant',
    actor: 'tenantSuperAdmin',
    method: 'DELETE',
    path: '/api/config/global/desactivar/tenant/superadmin/:id',
    title: 'Desactivar tenant SA',
    description: 'Desactiva un tenantSuperAdmin dentro de la rama autorizada, sin eliminar su registro.',
    fields: [{ name: 'id', label: 'Tenant SA a desactivar', type: 'id', required: true, pathParam: true }],
  },
  {
    id: 'tenant-superadmin-eliminar',
    section: 'tenant',
    actor: 'tenantSuperAdmin',
    method: 'DELETE',
    path: '/api/config/global/eliminar/tenant/superadmin/:id',
    title: 'Eliminar tenant SA',
    description: 'Elimina definitivamente un tenantSuperAdmin inactivo y sin relaciones dependientes.',
    fields: [{ name: 'id', label: 'Tenant SA a eliminar', type: 'id', required: true, pathParam: true }],
  },
  {
    ...
    actor: 'tenantSuperAdmin',
    method: 'PUT',
    path: '/api/config/global/actualizar/tenant/superadmin/:id',
    title: 'Actualizar tenant SA',
    description: 'Actualiza un tenantSuperAdmin descendiente de la rama autorizada por el JWT.',
    fields: [
      { name: 'id', label: 'Tenant SA descendiente', type: 'id', required: true, pathParam: true },
  ...
  {
    id: 'tenant-global-actualizar-propio',
    section: 'tenant',
    actor: 'tenantGlobal',
    method: 'PUT',
    path: '/api/config/global/actualizar/tenant/global/:id',
    title: 'Actualizar tenant TG',
    description: 'Edita un Tenant Global visible en el alcance JWT; para un actor TG el destino queda fijado a su propio tenant.',
    fields: [
      { name: 'id', label: 'Tenant Global', type: 'id', required: true, pathParam: true },
      { name: 'tipo_tenant', label: 'Tipo tenant', type: 'id' },
      { name: 'apisDominios', label: 'Apis dominios', type: 'id' },
      { name: 'accionesUsu', label: 'Acción usuario', type: 'id' },
      { name: 'rolesMabs', label: 'Rol mabs', type: 'id' },
    ],
  },
  {
