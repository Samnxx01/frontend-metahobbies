...
import { Loader2, Pencil, Plus, RefreshCw, Search, UserRoundCog } from 'lucide-react';
...
export default function TercerosCrudModal({ open, onOpenChange }: Props): React.ReactElement {
  ...
  const cargar = useCallback(async (): Promise<void> => {
    setLoading(true);
    try {
      const response = await terceroService.listarAdmin({ q: q.trim(), estado, limit: 100 });
