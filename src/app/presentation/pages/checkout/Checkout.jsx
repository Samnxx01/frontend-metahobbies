...
const SimpleInputField = ({ label, type = 'text' }) => (
...
export default function Checkout() {
    ...
    return (
        <div className="container max-w-4xl mx-auto py-8 px-4"> {/* Reemplaza Container maxWidth="md" */}
            <h1 className="text-3xl font-bold mb-8 text-center"> {/* Reemplaza Typography variant="h4" */}
                Finalizar Compra
            </h1>
            ...
            <div className="flex justify-center">
                ...
                {activeStep === 0 && (
                    <Card className="w-full max-w-2xl shadow-xl border"> {/* Reemplaza Paper */}
                        <CardContent className="p-6 sm:p-8">
                            <h2 className="text-xl font-semibold mb-6 flex items-center gap-2"> {/* Reemplaza Typography variant="h6" */}
                                <Truck className='w-5 h-5 text-primary' /> Datos de Envío
                            </h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4"> {/* Reemplaza Grid container spacing={2} */}
                ...
                {activeStep === 2 && (
                    <Card className="w-full max-w-2xl shadow-xl border"> {/* Reemplaza Paper */}
                        <CardContent className="p-8 sm:p-10 text-center">
                            ...
                            <h2 className="text-2xl font-bold mb-2"> {/* Reemplaza Typography variant="h5" */}
                                ¡Pedido Confirmado!
                            </h2>
                            <p className="text-muted-foreground mb-1">
                                Gracias por tu compra. Tu pedido ha sido procesado exitosamente.
                            </p>
                            <p className="text-sm text-muted-foreground mb-6 font-mono"> {/* Reemplaza Typography variant="body2" */}
                                Número de pedido: #123456
                            </p>
                            <Button size="lg" onClick={() => console.log('Navegar a pedidos')}> {/* Simula la navegación */}
