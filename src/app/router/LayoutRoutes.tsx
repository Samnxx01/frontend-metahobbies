...
const buildComponentMap = (): ComponentMapType => {
    ...
    const aliases: Record<string, string> = {
        ...
        PedidosAprobados:              'PedidosAprobadosCarrito',
        PedidosAprobadosCarrito:       'PedidosAprobadosCarrito',
        GestionPedidosAprobados:       'PedidosAprobadosCarrito',
        PedidosCarrito:                'PedidosAprobadosCarrito',
